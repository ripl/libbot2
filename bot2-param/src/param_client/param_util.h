...
//  Get a normalized BotTrans object from a calibration block that contains the
// subkeys: translation and a rotation specified as one of
...
// Get the rotation subcomponent of the block "name". Rotation is specified as
// one of quat, rpy (in degrees!), rodrigues, angleaxis
...
// Search through all the sensors to find the one which is published on this LCM
// channel
...
char* bot_param_get_sensor_coord_frame(BotParam* param,
                                       const char* sensor_prefix,
                                       const char* sensor_name);
char* bot_param_get_camera_coord_frame(BotParam* param,
                                       const char* camera_name);
char* bot_param_get_planar_lidar_coord_frame(BotParam* param,
