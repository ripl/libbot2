...
#ifndef BOT2_VIS_BOT_VIS_GL_UTIL_H_
#define BOT2_VIS_BOT_VIS_GL_UTIL_H_
 ...
 *
 * renders an arrow centered on the origina pointin along the x axis using
 * cylinders so it is visible from all angles
 */
...
#endif  // BOT2_VIS_BOT_VIS_GL_UTIL_H_
