...
#ifndef BOT2_LCM_UTILS_TUNNEL_LDPC_LDPC_FEC_SCHEME_H_
#define BOT2_LCM_UTILS_TUNNEL_LDPC_LDPC_FEC_SCHEME_H_
...
class LDPCFecScheme : public LDPCFecSession {
 ...
 public:
   ...
   */
  ldpc_error_status DetermineSymbolSize(INT64 objectSize, int pktSize,
                                        int* symbolSize, int* nbSourceSymbols);
   ...
   * @return    Completion status (LDPC_OK or LDPC_ERROR).
   */
  ldpc_error_status InitScheme(int symbolSize, int pktSize);
   ...
   * @return    Completion status (LDPC_OK or LDPC_ERROR).
   */
  ldpc_error_status BuildPkt(int pktIdx, void** pktBuffer,
                             void* symbol_canvas[], int* ESIofFirstSymbol);
   ...
   * @return    Completion status (LDPC_OK or LDPC_ERROR).
   */
  ldpc_error_status DecomposePkt(void* pktBuffer, int ESIofFirstSymbol,
   ...
   * @return    Completion status (LDPC_OK or LDPC_ERROR).
   */
  ldpc_error_status DecodingStepWithPkt(void* symbol_canvas[], void* pktBuffer,
...
inline int LDPCFecScheme::getNbSymbolsPerPkt() { return m_nbSymbolsPerPkt; }

inline int LDPCFecScheme::getNbSourcePkts() { return m_nbSourcePkts; }

inline int LDPCFecScheme::getNbSourceSymbols() { return m_nbSourceSymbols; }

inline int LDPCFecScheme::getNbParitySymbols() { return m_nbParitySymbols; }

inline int LDPCFecScheme::getNbParityPkts() { return m_nbParityPkts; }

#endif  // BOT2_LCM_UTILS_TUNNEL_LDPC_LDPC_FEC_SCHEME_H_
