...
#ifndef _lcm_tunnel_sub_msg_t_h
#define _lcm_tunnel_sub_msg_t_h

#ifdef __cplusplus
extern "C" {
#endif

typedef struct _lcm_tunnel_sub_msg_t lcm_tunnel_sub_msg_t;
struct _lcm_tunnel_sub_msg_t
{
    char*      channel;
    int32_t    data_size;
    uint8_t    *data;
...
typedef struct _lcm_tunnel_sub_msg_t_subscription_t lcm_tunnel_sub_msg_t_subscription_t;
typedef void(*lcm_tunnel_sub_msg_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const lcm_tunnel_sub_msg_t *msg, void *user);

int lcm_tunnel_sub_msg_t_publish(lcm_t *lcm, const char *channel, const lcm_tunnel_sub_msg_t *p);
lcm_tunnel_sub_msg_t_subscription_t* lcm_tunnel_sub_msg_t_subscribe(lcm_t *lcm, const char *channel, lcm_tunnel_sub_msg_t_handler_t f, void *userdata);
