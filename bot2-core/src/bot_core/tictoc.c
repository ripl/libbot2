...
static void _tictoc_t_print(gpointer data, gpointer user_data) {
  ...
  printf(
      "%30s: numCalls = %11d   totalT=%10.2f   avgT=%8.4f   minT=%8.4f   "
      "maxT=%8.4f   emaT=%8.4f\n",
      tt->description, tt->numCalls, totalT, avgT, minT, maxT, emaT);
}

static gint _tictoc_t_avgTimeCompare(gconstpointer a, gconstpointer b) {
...
static gint _tictoc_t_totalTimeCompare(gconstpointer a, gconstpointer b) {
  _tictoc_t* t1 = (_tictoc_t*)a;
  _tictoc_t* t2 = (_tictoc_t*)b;
  if (t1->numCalls < 1) {
    return 1;
...
static gint _tictoc_t_maxTimeCompare(gconstpointer a, gconstpointer b) {
  _tictoc_t* t1 = (_tictoc_t*)a;
  _tictoc_t* t2 = (_tictoc_t*)b;
  if (t1->numCalls < 1) {
    return 1;
...
static gint _tictoc_t_minTimeCompare(gconstpointer a, gconstpointer b) {
  _tictoc_t* t1 = (_tictoc_t*)a;
  _tictoc_t* t2 = (_tictoc_t*)b;
  if (t1->numCalls < 1) {
    return 1;
...
static gint _tictoc_t_emaTimeCompare(gconstpointer a, gconstpointer b) {
  _tictoc_t* t1 = (_tictoc_t*)a;
  _tictoc_t* t2 = (_tictoc_t*)b;
  if (t1->numCalls < 1) {
    return 1;
...
static gint _tictoc_t_alphCompare(gconstpointer a, gconstpointer b) {
  _tictoc_t* t1 = (_tictoc_t*)a;
  _tictoc_t* t2 = (_tictoc_t*)b;
  if (t1->numCalls < 1) {
    return 1;
...
int64_t bot_tictoc_full(const char* description, double ema_alpha,
  ...
  _tictoc_t* entry =
      (_tictoc_t*)g_hash_table_lookup(_tictoc_table, description);
  if (entry == NULL) {
    ...
    g_hash_table_insert(_tictoc_table, (gpointer)description, (gpointer)entry);
    ret = tictoctime;
...
static void _get_all_vals_helper(gpointer key, gpointer value,
                                 gpointer user_data) {
