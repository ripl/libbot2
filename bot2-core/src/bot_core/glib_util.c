...
void bot_g_list_free_with_func(GList* list, GDestroyNotify functor) {
  GList* iter;
...
static void get_all_keys_helper(gpointer key, gpointer value,
                                gpointer user_data) {
...
static void get_all_vals_helper(gpointer key, gpointer value,
                                gpointer user_data) {
...
static void get_all_vals_array_helper(gpointer key, gpointer value,
                                      gpointer user_data) {
