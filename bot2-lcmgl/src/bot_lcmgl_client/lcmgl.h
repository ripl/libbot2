...
#ifndef BOT2_LCMGL_BOT_LCMGL_CLIENT_LCMGL_H_
#define BOT2_LCMGL_BOT_LCMGL_CLIENT_LCMGL_H_
...
void bot_lcmgl_color4f(bot_lcmgl_t* lcmgl, float v0, float v1, float v2,
                       float v3);
...
void bot_lcmgl_rotated(bot_lcmgl_t* lcmgl, double angle, double x, double y,
                       double z);
...
static inline void bot_lcmgl_vertex2fv(bot_lcmgl_t* lcmgl, const float v[2]) {
  bot_lcmgl_vertex2f(lcmgl, v[0], v[1]);
}
static inline void bot_lcmgl_vertex2dv(bot_lcmgl_t* lcmgl, const double v[2]) {
  bot_lcmgl_vertex2d(lcmgl, v[0], v[1]);
}

static inline void bot_lcmgl_vertex3fv(bot_lcmgl_t* lcmgl, const float v[3]) {
  bot_lcmgl_vertex3f(lcmgl, v[0], v[1], v[2]);
}
static inline void bot_lcmgl_vertex3dv(bot_lcmgl_t* lcmgl, const double v[3]) {
  bot_lcmgl_vertex3d(lcmgl, v[0], v[1], v[2]);
}

static inline void bot_lcmgl_color3fv(bot_lcmgl_t* lcmgl, const float v[3]) {
  bot_lcmgl_color3f(lcmgl, v[0], v[1], v[2]);
}
static inline void bot_lcmgl_color4fv(bot_lcmgl_t* lcmgl, const double v[4]) {
  bot_lcmgl_color4f(lcmgl, v[0], v[1], v[2], v[3]);
}
...
#define lcmglMaterialf(face, name, c0, c1, c2) \
  bot_lcmgl_materialf(lcmgl, face, name, c0, c1, c2, c3);
#define lcmglMaterialfv(face, name, c) \
  bot_lcmgl_materialf(lcmgl, face, name, c[0], c[1], c[2], c[3]);
 ...
 * @see: gluCylinder
 */
void bot_lcmgl_cylinder(bot_lcmgl_t* lcmgl, double base_xyz[3],
 ...
 *
 * renders a circle in the xy, xz, yz plane of unit radius at the origin with
 ...
 */
void bot_lcmgl_draw_arrow_3d(bot_lcmgl_t* lcmgl, double length,
...
#define lcmglCylinder(xyz, base_radius, top_radius, height, slices, stacks) \
  bot_lcmgl_cylinder(lcmgl, xyz, base_radius, top_radius, height, slices,   \
                     stacks)
 ...
 * called.
 */
int bot_lcmgl_texture2d(bot_lcmgl_t* lcmgl, const void* data, int width,
...
void bot_lcmgl_texture_draw_quad(bot_lcmgl_t* lcmgl, int texture_id,
                                 ...
                                 double z_top_left, double x_bot_left,
                                 double y_bot_left, double z_bot_left,
                                 double x_bot_right, double y_bot_right,
                                 double z_bot_right, double x_top_right,
                                 double y_top_right, double z_top_right);
...
#endif  // BOT2_LCMGL_BOT_LCMGL_CLIENT_LCMGL_H_
